...
public class Node {
    ...
    public ExpressionsEnum expression_;
    public int value_;
    Node[] children_;
    Node parent_;

    Node(ExpressionsEnum expression, Node[] children, Node parent){
        expression_ = expression;
        children_ = children;
        parent_ = parent;
        value_ = -1;
    }
    Node(ExpressionsEnum expression, Node[] children, Node parent, int value){
        expression_ = expression;
        children_ = children;
        parent_ = parent;
        value_ = value;
